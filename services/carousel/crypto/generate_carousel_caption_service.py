...
from prompts.carousel.crypto.generate_carousel_caption import PROMPT_GENERATE_CAROUSEL_CAPTION
from prompts.carousel.crypto.generate_carousel_linkedin import PROMPT_GENERATE_LINKEDIN_POST
