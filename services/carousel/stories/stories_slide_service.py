"""
Génération des slides Stories (1080x1350) via Pillow.
Stack: image + filter + stories_bg_bas + texte.
"""
...
ASSETS_DIR = os.path.join(
    ...
    "..", "..", "..",
    "front", "layout", "assets", "carousel", "stories",
)

CANVAS_SIZE = (1080, 1920)  # Format Instagram Stories 9:16
...
def generate_stories_slide(
    ...
    """
    Génère une slide Stories (1-4) avec le style Eco :
    ...
    if not image_url and not image_bytes:
        raise ValueError("Aucune image disponible pour le stories.")
...
def generate_cover_slide(
    ...
    """
    Génère la slide de couverture (slide 0) pour Stories.
