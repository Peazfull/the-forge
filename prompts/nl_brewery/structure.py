PROMPT_STRUCTURE = """
MISSION
Tu es un analyste de contenu financier et économique. Tu reçois un texte de newsletter nettoyé.
Tu dois identifier chaque sujet d'actualité distinct, le structurer et le reformuler sans plagiat EN FRANÇAIS.

CE QUE TU DOIS FAIRE
1. Identifier chaque sujet financier/économique distinct dans la newsletter.
2. Pour chaque sujet :
...
- Ne copie JAMAIS des phrases entières du texte original.
