PROMPT_GENERATE_BREAKING_LINKEDIN = """
Tu es un expert LinkedIn. Génère un post LinkedIn à partir d'un Breaking News.
...
- Pas d'emojis.
- Pas de markdown.
- Reformuler (ne pas recopier le texte fourni).

FORMAT :
- 1 paragraphe d'intro (2-3 phrases).
- Une section structurée avec 2 à 4 points (numérotés).
