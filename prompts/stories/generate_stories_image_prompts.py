PROMPT_GENERATE_STORIES_IMAGE_PROMPT = """
...
The lighting in the lower part of the image features a strong, clearly defined stylized sunset atmosphere using the official fluo palette: intense cyan blue, vivid magenta, rich coral, deep fluo green, and warm glowing orange. These colors must be visible in the sky and naturally reflected on the building, windows, flag and surrounding surfaces. Reflections must feel physically plausible, not graphic.
