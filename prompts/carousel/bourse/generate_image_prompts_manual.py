...
SUBJECT (MANDATORY)
Tesla as the single central subject, illustrated through their corporate facilities.
The image must represent a specific business announcement: quarterly earnings beat expectations, vehicle delivery records, factory expansion, or strategic initiative.
Example: "Tesla Q3 earnings exceed Wall Street forecasts" or "Tesla Gigafactory Texas achieves production milestone".
...
CONTEXT (MANDATORY – CORPORATE FINANCIAL ENVIRONMENT)
Tesla Gigafactory, corporate headquarters, or manufacturing facility.
OBLIGATORY visual identifiers:
- Authentic TESLA logo prominently displayed on building facade (official Tesla "T" logo signage)
- Modern automotive manufacturing facility or corporate building architecture
- Professional business environment photographed from exterior
- Clean, premium corporate aesthetic suggesting innovation, market success, and financial strength
The logo must appear as in real financial press photography covering Tesla's quarterly results or business milestones (Bloomberg, Reuters, Les Échos).
