...
SUBJECT (MANDATORY)
Tesla as the single central subject, illustrated through their Gigafactory or corporate headquarters.
The image must represent a specific financial/business milestone: record quarterly earnings, production targets achieved, new factory opening, or stock market performance.
Example: "Tesla reports 30% revenue growth in Q4" or "Tesla Gigafactory Berlin reaches full production capacity".
...
CONTEXT (MANDATORY – CORPORATE FINANCIAL SETTING)
Tesla Gigafactory or corporate headquarters building.
OBLIGATORY visual identifiers:
- Authentic TESLA logo prominently displayed on building facade (official Tesla "T" logo signage)
- Modern automotive/industrial facility or corporate tower architecture
- Professional business environment photographed from exterior
- Clean, premium corporate aesthetic suggesting technological innovation and market disruption
The logo must appear as in real financial press photography covering Tesla's business performance (Bloomberg, Financial Times, Reuters).
...
NO bar charts, line graphs, pie charts, or statistical displays anywhere.
NO stock tickers, trading screens, or financial dashboards.
