...
def generate_all_slide_previews():
    ...
    outro_path = os.path.join(
        ...
        "..", "layout", "assets", "carousel", "bourse", "outro_bourse.png"
    )
    ...
    if carousel_data["status"] == "error":
        ...
        for idx, item in enumerate(items_with_outro):
            ...
            if not image_url and item_id != "outro":
                try:
                    supabase = get_supabase()
                    image_bytes = supabase.storage.from_("carousel-bourse").download(f"image_{item_id}.png")
                except Exception:
            ...
            with col:
                ...
                if item_id == "outro":
                    ...
                    if "slide_outro.png" in stored_files:
                        ...
                        st.warning("outro_bourse.png introuvable")
                    continue
