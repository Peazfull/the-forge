...
SLIDE2_START_Y = 500  # Ajusté pour 1080x1350 (était 400 pour 1080x1080)
...
SLIDE3_TITLE_ASSET_TOP = 388  # Ajusté pour 1080x1350
SLIDE4_TITLE_ASSET = os.path.join(ASSETS_DIR, "Top_10_fr.png")
SLIDE4_TITLE_ASSET_TOP = 388  # Ajusté pour 1080x1350
SLIDE5_TITLE_ASSET = os.path.join(ASSETS_DIR, "Flop_10_fr.png")
SLIDE5_TITLE_ASSET_TOP = 388  # Ajusté pour 1080x1350
SLIDE6_TITLE_ASSET = os.path.join(ASSETS_DIR, "Indices_eur.png")
SLIDE6_TITLE_ASSET_TOP = 388  # Ajusté pour 1080x1350
SLIDE7_TITLE_ASSET = os.path.join(ASSETS_DIR, "Commos_eur.png")
SLIDE7_TITLE_ASSET_TOP = 388  # Ajusté pour 1080x1350
SLIDE8_TITLE_ASSET = os.path.join(ASSETS_DIR, "Devises_eur.png")
SLIDE8_TITLE_ASSET_TOP = 388  # Ajusté pour 1080x1350
SLIDE9_TITLE_ASSET = os.path.join(ASSETS_DIR, "Cryptos_eur.png")
SLIDE9_TITLE_ASSET_TOP = 388  # Ajusté pour 1080x1350
...
def _get_top10_open_fr() -> list[dict]:
    try:
...
def _render_slide_bytes(filename: str, path: str) -> bytes:
    ...
    if slide_number == 1:
        ...
        _render_open_table(draw, img.size[0], img.size[1], rows, custom_start_y=table_start_y)
    elif slide_number == 3:
        draw = ImageDraw.Draw(img)
        rows = _get_flop10_open_eu()
